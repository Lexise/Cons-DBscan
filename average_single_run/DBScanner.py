...
from sklearn.metrics import fowlkes_mallows_score, calinski_harabaz_score, f1_score, homogeneity_completeness_v_measure
...
class DBScanner:
    ...
    def dbscan(self, must_link, cannot_link):
        ...
        for point in range(self.__data.shape[0]):
